...
class areaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["namaArea"].widget.attrs.update(
            {'type': "text", 'id': "namaArea", 'name': 'area', 'label': 'Nama Area', 'help text': 'Nama Area', 'required': 'True', 'autocomplete': 'off'})
...
class subareaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["namaSubarea"].widget.attrs.update(
            {'type': "text", 'id': "namaSubarea", 'class': "formset-field", 'name': 'subarea', 'required': 'True', 'autocomplete': 'off'})
